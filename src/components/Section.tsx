  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-16 md:pt-44 md:pb-24">
      ...
      <Container className="relative">
        <div className="rise"><Eyebrow>{eyebrow}</Eyebrow></div>
        <h1 style={{ animationDelay: "80ms" }} className="rise display mt-6 max-w-5xl text-[2.9rem] md:text-[5rem] lg:text-[6.2rem]">{title}</h1>
        {lede && <p style={{ animationDelay: "160ms" }} className="rise mt-8 max-w-2xl text-lg leading-relaxed text-ink-2 md:text-xl">{lede}</p>}
      </Container>
    </section>
  );
}
