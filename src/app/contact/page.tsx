        ...
        <Container className="grid gap-16 md:grid-cols-12">
          <Reveal className="md:col-span-4">
            ...
            <address className="not-italic leading-relaxed text-ink-2">
              <Sieve /> technologies LIMITED<br />1 Francis St, Dundalk<br />Louth A91 XK38<br />Ireland
            </address>
            <p className="eyebrow mb-4 mt-12">Elsewhere</p>
            <a className="u-link" href="https://www.linkedin.com/company/i-sieve-technologies" target="_blank" rel="noreferrer">LinkedIn</a>
          </Reveal>
