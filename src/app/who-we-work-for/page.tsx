...
import { Brandify } from "@/components/Brand";
        ...
        >
          <Container className="grid gap-10 py-20 md:grid-cols-12 md:py-28">
            <Reveal className="md:col-span-5">
              ...
              <p className="display mt-8 text-xl leading-snug text-ink-2 md:text-2xl"><Brandify>{a.lede}</Brandify></p>
            </Reveal>
            <Reveal delay={120} className="md:col-span-6 md:col-start-7 md:pt-12">
              <p className="text-lg leading-relaxed text-ink-2"><Brandify>{a.body}</Brandify></p>
            </Reveal>
          </Container>
        </section>
      ))}
